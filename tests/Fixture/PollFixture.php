...
class PollFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'state' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'poll_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
'engine' => 'InnoDB', 'collation' => 'latin1_swedish_ci'
    ...
    public $records = [
        [
            ...
            'created' => '2015-04-25 05:43:16',
            'modified' => '2015-04-25 05:43:16'
        ],
    ];
}
